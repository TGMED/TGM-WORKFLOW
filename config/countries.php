...
|--------------------------------------------------------------------------
|
| Keyed by ISO 3166-1 alpha-2, carrying the display name and the E.164 dial
| code. The profile forms use this for country of origin and for the dial
| code prefix on every phone field, so the two lists cannot drift apart.
|
*/
...
return [
    ...
    'CG' => ['name' => 'Congo (Republic)', 'dial' => '+242'],
